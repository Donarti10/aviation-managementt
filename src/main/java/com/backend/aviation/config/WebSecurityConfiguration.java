package com.backend.aviation.config;
...
public class WebSecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests().antMatchers("/api/tests/save").access("hasRole('ADMIN')")
                .and()
                ...
                .contentSecurityPolicy("default-src 'self'"); // Configure CSP
        ...
        http.csrf().disable()
                ...
                .maximumSessions(1) // Session Concurrency Control
    ...
    public AuthenticationEntryPoint myAuthenticationEntryPoint() {
        return (request, response, authException) -> {
            ...
            sendErrorResponse(response, HttpServletResponse.SC_UNAUTHORIZED, "You have no permission to make this operation. Please log in with an authorized user");
        };
    }
